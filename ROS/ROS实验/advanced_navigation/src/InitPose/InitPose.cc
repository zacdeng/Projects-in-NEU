...
public:
    ...
    void Run(void) override
    {
        ...
        // Step 2 设置机器人的初始位姿
            ...
            // Step 2.1 设置消息
            SetInitPoseMsg(gazeboSrvExist, mSrvGzbModelState.response.pose);

            // Step 2.2 等待 topic 具有订阅者
            // TODO 2.2.4
            while(mPubInitPose.getNumSubscribers() == 0) //没有订阅者时
            {
...
private:
    ...
    void SetInitPoseMsg(bool gazeboSrvExist, geometry_msgs::Pose msgP)
    {
